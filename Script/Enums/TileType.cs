...
public enum TileType {
    AIR, STONE, COAL, IRON, COPPER, TIN, ALUMINUM, GOLD, DIAMOND, EMERALD, AMETHYST, BEDROCK
}

public static class TileTypeExtensions {
    private static readonly Dictionary<TileType, Texture2D> _itemTextures = new() {
        ...
        {TileType.ALUMINUM, GD.Load<Texture2D>("res://Assets/Textures/Items/aluminum.png")},
        ...
        {TileType.AMETHYST, GD.Load<Texture2D>("res://Assets/Textures/Items/amethyst.png")},
